...
forge.permissions = {
    ...
    check: function (permission, success, error) {
        ...
        if (permission === "ios.permission.contacts") {
            forge.permissions._ios_check("contact", options, success, error);
        } else if (permission === "ios.permission.calendar") {
            forge.permissions._ios_check("calendar", options, success, error);
        } else if (permission === "ios.permission.reminders") {
            forge.permissions._ios_check("calendar", options, success, error);
        } else if (permission === "ios.permission.camera") {
            ...
            forge.internal.call("permissions.check", options, success, error);
        }
    },
    ...
    request: function (permission, rationale, success, error) {
        ...
        if (permission === "ios.permission.contacts") {
            forge.permissions._ios_request("contact", options, success, error);
        } else if (permission === "ios.permission.calendar") {
            forge.permissions._ios_request("calendar", options, success, error);
        } else if (permission === "ios.permission.reminders") {
            forge.permissions._ios_request("calendar", options, success, error);
        } else if (permission === "ios.permission.camera") {
    ...
    _ios_check: function (module, options, success, error) {
        if (module in forge) {
            forge.internal.call(module + ".permissions_check", options, success, error);
        } else {
            error("Failed to check permission. Please make sure you have added the latest version of the '" + module + "' module to your app.");
        }
    },

    _ios_request: function (module, options, success, error) {
        if (module in forge) {
            forge.internal.call(module + ".permissions_request", options, success, error);
        } else {
            error("Failed to request permission. Please make sure you have added the latest version of the '" + module + "' module to your app.");
        }
    }
};
